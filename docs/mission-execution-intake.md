...
|---|---|---|---|---|---:|
| `MSN-001` — Preserve real co-author attribution across remaining merge methods | participant-needed | pair-extraordinaire | CLM-005 | CTR-004 | 8 |
| `MSN-008` — Observe exact Pair Extraordinaire tier transitions | blocked | pair-extraordinaire | CLM-006 | CTR-004 | 9 |
...
| `MSN-006` — Run the active YOLO submitted-review-state matrix | active | yolo | CLM-004 | CTR-002 | 9 |
