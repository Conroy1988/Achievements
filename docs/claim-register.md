...
| `CLM-007` | galaxy-brain | trigger | official | `RSH-011` | maintained-with-limitations |
...
| `CLM-011` | public-sponsor | trigger | official | `RSH-012` | maintained-with-limitations |
| `CLM-012` | arctic-code-vault-contributor | historical-trigger | official | `RSH-006` | historical |
| `CLM-013` | mars-2020-contributor | historical-trigger | official | `RSH-007` | historical |
